...
import 'package:internshipapp/bloc/profile/bloc.dart';
import 'package:internshipapp/bloc/profile/profile_bloc.dart';
import 'package:internshipapp/repositories/userRepository.dart';
import 'package:internshipapp/allui/constants.dart';
import 'package:internshipapp/allui/widgets/gender.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      child: photo == null
                          ? GestureDetector(
                        onTap: () async {
                          FilePickerResult getPic = await FilePicker.platform.pickFiles(
                              type: FileType.image);
                          if (getPic != null) {
                            setState(() {
                  ...
                  GestureDetector(
                    ...
                    child: Text(age==null?"Enter Birthday":age.toString().split(' ')[0], style: TextStyle(color: Colors.white, fontSize: size.width * 0.09),),
                  ),
                  SizedBox(
                    height: 10.0,
                  ),
