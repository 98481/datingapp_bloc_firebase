import 'package:internshipapp/bloc/matches/bloc.dart';
import 'package:internshipapp/models/user.dart';
import 'package:internshipapp/repositories/matchesRepository.dart';
import 'package:internshipapp/allui/widgets/iconWidget.dart';
import 'package:internshipapp/allui/widgets/pageTurn.dart';
import 'package:internshipapp/allui/widgets/profile.dart';
import 'package:internshipapp/allui/widgets/userGender.dart';
          ...
          return CustomScrollView(
            slivers: <Widget>[
              ...
              StreamBuilder<QuerySnapshot>(
                stream:  FirebaseFirestore.instance.collection('users').doc(widget.userId).collection('matchedList').snapshots(),
                          ...
                          return GestureDetector(
                            onTap: () async {
                              User selectedUser = await matchesRepository
                                  .getUserDetails(snapshot.data.docs[index].id);
                            ...
                            child: profileWidget(
                              padding: size.height * 0.01,
                              photo: snapshot.data.docs[index].get('photoUrl'),
              ...
              StreamBuilder<QuerySnapshot>(
                stream:  FirebaseFirestore.instance.collection('users').doc(widget.userId).collection('selectedList').snapshots(),
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return SliverToBoxAdapter(
                      child: Container(),
